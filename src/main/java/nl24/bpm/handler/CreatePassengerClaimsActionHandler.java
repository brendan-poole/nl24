...
@Service
public class CreatePassengerClaimsActionHandler extends ActionHandler {
	...
	public CreatePassengerClaimsActionHandler() {
		LOG.debug(this);
	}
